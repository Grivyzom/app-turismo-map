...
export const FurnitureMarker: React.FC<FurnitureMarkerProps> = React.memo(
  ({ item, isDark = true, isSelected = false, onPress }) => {
    const icon = useMemo(() => {
      switch (item.amenity) {
        case 'bench':
      ...
      >
        <View style={styles.container}>
          {isSelected && (
            ...
            >
              <Text style={[styles.tooltipText, { color: textColor }]}>{displayName}</Text>
